 ...
 * @author mallik
 */
public class SimToolkitApplet extends Applet {
 ...
 final static byte Wallet_CLA =(byte)0xB0;
  ...
  final static byte View1 =(byte) 0x70;
  final static byte View2 =(byte) 0x80;
  final static byte View3 =(byte) 0x90;
  final static byte GOOGLE =(byte) 0x95;
  final static byte OPENMENU =(byte) 0x00;
  ...
  short item;
    ...
    public static void install(byte[] bArray, short bOffset, byte bLength) {
        new SimToolkitApplet(bArray, bOffset, bLength);
     ...
     */
    protected SimToolkitApplet(byte[] bArray, short bOffset, byte bLength) {
   ...
   public void deselect() {
    ...
    switch (buffer[ISO7816.OFFSET_INS]) {
        ...
        case OPENMENU: openMenu(apdu);
          return;
         case View1: viewMenu1(apdu);
          return;
          case View2: viewMenu2(apdu);
          return;
          case View3: viewMenu3(apdu);
          return;
    ...
    private void viewMenu1(APDU apdu) {
    ...
    apdu.sendBytes((short)0, (short)2);
      ...
      private void viewMenu2(APDU apdu) {
        //throw new java.lang.UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    //if ( ! pin.isValidated()) ISOException.throwIt(SW_PIN_VERIFICATION_REQUIRED);
    byte[] buffer = apdu.getBuffer();
    // inform system that the applet has finished
    ...
    apdu.sendBytes((short)0, (short)2);
       ...
       private void viewMenu3(APDU apdu) {
        //throw new java.lang.UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    //if ( ! pin.isValidated()) ISOException.throwIt(SW_PIN_VERIFICATION_REQUIRED);
    byte[] buffer = apdu.getBuffer();
    // inform system that the applet has finished
    ...
    apdu.sendBytes((short)0, (short)2);
       ...
       private void viewMenu4(APDU apdu) {
        //throw new java.lang.UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    //if ( ! pin.isValidated()) ISOException.throwIt(SW_PIN_VERIFICATION_REQUIRED);
    byte[] buffer = apdu.getBuffer();
    // inform system that the applet has finished
   ...
   // BrowserApp app1 = new BrowserApp();
   
    
    }
         private void GoogleSearch(APDU apdu) {
        //throw new java.lang.UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    //if ( ! pin.isValidated()) ISOException.throwIt(SW_PIN_VERIFICATION_REQUIRED);
    byte[] buffer = apdu.getBuffer();
    // inform system that the applet has finished
    ...
    //informs the CAD the actual number of bytes
    //returned
     byte searchByte = buffer[ISO7816.OFFSET_CDATA];
    apdu.setOutgoingLength((byte)2);
       buffer[0]=searchByte;
       buffer[1]=0;
            //System.err.println("16this is the data out"+dataOut[i]);
             //buffer[i] = (byte)searchByte[i];
   ...
   // BrowserApp app1 = new BrowserApp();
           ...
           private void openMenu(APDU apdu) {
        //throw new java.lang.UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    //if ( ! pin.isValidated()) ISOException.throwIt(SW_PIN_VERIFICATION_REQUIRED);
    byte[] buffer = apdu.getBuffer();
    // inform system that the applet has finished
